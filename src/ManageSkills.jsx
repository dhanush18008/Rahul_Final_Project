...
function ManageSkills() {
    ...
    <div className='flex flex-row w-full'>
        <div className='w-full'>
          <h1 className='text-6xl py-11 font-lato ml-20'>Welcome User!!</h1>
        <p className='text-2xl py-3 text-indigo-600 ml-40 font-lato'>Here you can manage skills of an Employee </p>
        <div className='flex flex-col py-10 w-64 ml-64 gap-7'>
        <input
      ...
      width: '60%', // Cover half of the screen width
